...
set_server_hostname(::X509_VERIFY_PARAM* param, string_view hostname, std::error_code& ec)
{
...
BOOST_CERTIFY_DECL void
set_server_hostname(::SSL* handle, string_view hostname, std::error_code& ec)
{
